    ...
    return `
        ...
        <div class="${classes.relatedLinks}">
          ...
          <ul>
            ...
            <li><a href="https://opustools.xyz/blog/the-ultimate-image-resizer-guide-resizing-images-to-20kb-50kb-and-beyond" target="_blank" rel="noopener noreferrer">The Ultimate Image Resizer Guide</a></li>
          </ul>
        </div>
    `;
};
